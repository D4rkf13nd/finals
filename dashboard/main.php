...
<head>
    ...
    .chart-container, .barangay-container {
        position: relative;
        background: white;
        padding: 15px;
        border-radius: 8px;
...
<body>
    ...
    <div class="main-content position-relative">
        <div id="mainContentLoader" class="loader-container">
    ...
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-md-7 mb-3">
                <div class="barangay-container position-relative">
                    <div id="barangayChartLoader" class="loader-container" style="display:none;">
                        <div class="loader"></div>
                    </div>
            ...
            <div class="col-md-5 mb-3">
                <div class="chart-container position-relative">
                    <div id="genderChartLoader" class="loader-container" style="display:none;">
                        <div class="loader"></div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartButtons = document.querySelectorAll('#barBtn, #lineBtn, #pieBtn');
    const barangayLoader = document.getElementById('barangayChartLoader');
    const genderLoader = document.getElementById('genderChartLoader');
    
    // Show loaders when chart type changes
    chartButtons.forEach(button => {
        button.addEventListener('click', function() {
            // Display loaders immediately
            barangayLoader.style.display = 'flex';
            genderLoader.style.display = 'flex';

            // Hide loaders after chart update
            setTimeout(function() {
                barangayLoader.style.display = 'none';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const mainLoader = document.getElementById('mainContentLoader');
