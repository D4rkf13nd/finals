...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Generation counting based on birthday
    ...
    <div class="main-content">
        ...
        <div class="row mb-4">
            ...
            <div class="generation-item">
                ...
                <div class="generation-value"><?= $generationCounts["Gen_Z"] ?></div>
            </div>
            <div class="generation-item">
                <div class="generation-millennials">Millennials</div>
                <div class="generation-value"><?= $generationCounts["Millennials"] ?></div>
    
            </div>
            <div class="generation-item">
                <div class="generation-x">Gen X</div>
                <div class="generation-value"><?= $generationCounts["Gen_X"] ?></div>
            </div>
            <div class="generation-item">
                <div class="generation-baby">Baby Boomers</div>
                <div class="generation-value"><?= $generationCounts["Boomers"] ?></div>
            </div>
            <div class="generation-item">
                <div class="generation-silent">Silent Generation</div>
                <div class="generation-value"><?= $generationCounts["Silent"] ?></div>
            </div>
        </div>
