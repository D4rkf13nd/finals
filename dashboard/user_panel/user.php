        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="counter-18">
                    ...
                    <div class="counter-percent" 
                         data-value="<?= $totalPopulation > 0 ? round(($ageGroups["18-30"] / $totalPopulation) * 100, 1) : 0 ?>">
                        0
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="counter-31">
                    <h6>Age 31-50</h6>
                    <div class="counter-percent" 
                         data-value="<?= $totalPopulation > 0 ? round(($ageGroups["31-50"] / $totalPopulation) * 100, 1) : 0 ?>">
                        0
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="counter-51">
                    <h6>Age 51-60</h6>
                    <div class="counter-percent" 
                         data-value="<?= $totalPopulation > 0 ? round(($ageGroups["51-60"] / $totalPopulation) * 100, 1) : 0 ?>">
                        0
                    </div>
                </div>
            </div>
...
function animateCounter(element, start, end, duration = 2000) {
    ...
    function updateCounter(currentTime) {
        ...
        // Always format with one decimal place for percentages
        element.textContent = element.classList.contains('counter-percent') 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (totalCounter) {
        animateCounter(totalCounter, 0, parseInt(totalCounter.textContent));
    }
